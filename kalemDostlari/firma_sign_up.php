...
<div>
  <div class="col-4 tableOuter container  rounded-lg border border-dark text-center " style="margin:10px; margin:10px; background-color:rgb(211,189,166); border-color: white; color: black;">
    ...
    <form action="firma_sign_up_do.php" method="POST" class="form-control form-control-lg" type="text" placeholder=".form-control-lg">
...
<button type="submit" class="submit rounded border border-dark shadow-lg" name="kayit" id="kayit" onclick="redirectToKayit()">Geri Dön</button>
</div>
    <p>Hesabım Var  </p>
